...
if("TRUE" STREQUAL "TRUE")
  set(descartes_core_SOURCE_PREFIX /home/luis/catkin_ws/src/descartes/descartes_core)
  set(descartes_core_DEVEL_PREFIX /home/luis/catkin_ws/devel)
  ...
  set(descartes_core_INSTALL_PREFIX /home/luis/catkin_ws/install)
...
if(NOT "/home/luis/catkin_ws/src/descartes/descartes_core/include;/usr/include;/usr/include/eigen3 " STREQUAL " ")
  set(descartes_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/luis/catkin_ws/src/descartes/descartes_core/include;/usr/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'descartes_core' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Jorge Nicho <jnicho@swri.org>, Jonathan Meyer <jonathan.meyer@swri.org>, Shaun Edwards <sedwards@swri.org>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'descartes_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/luis/catkin_ws/src/descartes/descartes_core/${idir}'.  Ask the maintainer 'Jorge Nicho <jnicho@swri.org>, Jonathan Meyer <jonathan.meyer@swri.org>, Shaun Edwards <sedwards@swri.org>' to fix it.")
    endif()
...
set(depends "roscpp;moveit_core")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${descartes_core_dep}_FOUND)
      find_package(${descartes_core_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${descartes_core_dep} REQUIRED ${depend_list})
  endif()
...
set(pkg_cfg_extras "/home/luis/catkin_ws/src/descartes/descartes_core/cmake/descartes_core-extras.cmake")
